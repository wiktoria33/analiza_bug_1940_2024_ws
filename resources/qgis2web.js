...
map.getView().fit([2348578.517390, 6891213.427350, 2357121.578975, 6896223.821530], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza Bug 1940-2024</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (445 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Projekt „Analiza zmian koryta rzeki Bug w latach 1940-2024” został wykonany w ramach przedmiotu SIP na piątym semestrze studiów inżynierskich na kierunku Gospodarka Przestrzenna na Politechnice Warszawskiej w roku akademickim 2024/2025. Projekt wykonany został przy pomocy oprogramowania ArcGis Pro. Celem projektu było opracowanie analiz jakościowych i ilościowych zmiany przebiegu koryta rzeki Bug w latach 1940-2024. <br />Autor: Wiktoria Serwatka';
            }
